<style lang="less">
@import url("./facetest.less");
</style>
<template>
    <div class="facetest_main">
        <Row :gutter="16">
            <Col span="12">
                <Card>
                    <p slot="title">
...
export default {
    ...
    data() {
        return {
            ...
            uploadActionUrl: config.HOST+"/persons/recognize",
            results:[],//搜索结果图像
            boxes:[],
            previewImgSrc:'',
            isProcessing:false,
